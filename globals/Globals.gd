...
var map_size: Vector2 = Vector2(43, 25)
...
var units = { UNITS.LIGHT_INFANTRY: 
				...
				w2_can_attack = [UNITS.LIGHT_INFANTRY, UNITS.HEAVY_INFANTRY,
					...
					UNITS.ARTILLERY, UNITS.HEAVY_ARTILLERY, UNITS.ANTI_AIR,
					UNITS.DRONE],
				move_type = MOVE_TYPE.INFANTRY,
				w1_dmg_chart = {UNITS.LIGHT_INFANTRY: 0, UNITS.HEAVY_INFANTRY: 0,
					UNITS.RECON: 0, UNITS.LIGHT_TANK: 0, UNITS.MEDIUM_TANK: 0,
					UNITS.ARTILLERY: 0, UNITS.HEAVY_ARTILLERY: 0, UNITS.ANTI_AIR: 0,
					UNITS.DRONE: 0, UNITS.BATTLESHIP: 0},
			...
			UNITS.HEAVY_INFANTRY: 
				...
				w2_dmg_chart = {UNITS.LIGHT_INFANTRY: 65, UNITS.HEAVY_INFANTRY: 55,
					UNITS.RECON: 18, UNITS.LIGHT_TANK: 6, UNITS.MEDIUM_TANK: 1,
					UNITS.ARTILLERY: 32, UNITS.HEAVY_ARTILLERY: 35, UNITS.ANTI_AIR: 6,
			...
			UNITS.LIGHT_TANK:
				...
				w1_dmg_chart = {UNITS.LIGHT_INFANTRY: 0, UNITS.HEAVY_INFANTRY: 0,
					UNITS.RECON: 85, UNITS.LIGHT_TANK: 55, UNITS.MEDIUM_TANK: 15,
					UNITS.ARTILLERY: 70, UNITS.HEAVY_ARTILLERY: 85, UNITS.ANTI_AIR: 65,
					UNITS.DRONE: 0, UNITS.BATTLESHIP: 1},
				w2_dmg_chart = {UNITS.LIGHT_INFANTRY: 75, UNITS.HEAVY_INFANTRY: 70,
					UNITS.RECON: 40, UNITS.LIGHT_TANK: 6, UNITS.MEDIUM_TANK: 1,
					UNITS.ARTILLERY: 45, UNITS.HEAVY_ARTILLERY: 55, UNITS.ANTI_AIR: 5,
					UNITS.DRONE: 9, UNITS.BATTLESHIP: 0},
				atk_type = ATTACK_TYPE.DIRECT,
				cost = 7000,
				can_capture = false},
			UNITS.MEDIUM_TANK:
				...
				w1_dmg_chart = {UNITS.LIGHT_INFANTRY: 0, UNITS.HEAVY_INFANTRY: 0,
					...
					UNITS.DRONE: 0, UNITS.BATTLESHIP: 10},
				w2_dmg_chart = {UNITS.LIGHT_INFANTRY: 105, UNITS.HEAVY_INFANTRY: 95,
					UNITS.RECON: 45, UNITS.LIGHT_TANK: 8, UNITS.MEDIUM_TANK: 1,
					UNITS.ARTILLERY: 45, UNITS.HEAVY_ARTILLERY: 55, UNITS.ANTI_AIR: 7,
					UNITS.DRONE: 12, UNITS.BATTLESHIP: 0},
				atk_type = ATTACK_TYPE.DIRECT,
				cost = 15000,
				can_capture = false},
			UNITS.ARTILLERY:
				...
				w2_dmg_chart = {UNITS.LIGHT_INFANTRY: 0, UNITS.HEAVY_INFANTRY: 0,
					UNITS.RECON: 0, UNITS.LIGHT_TANK: 0, UNITS.MEDIUM_TANK: 0,
					UNITS.ARTILLERY: 0, UNITS.HEAVY_ARTILLERY: 0, UNITS.ANTI_AIR: 0,
					UNITS.DRONE: 0, UNITS.BATTLESHIP: 0},
			...
			UNITS.DRONE:
				...
				w1_dmg_chart = {UNITS.LIGHT_INFANTRY: 0, UNITS.HEAVY_INFANTRY: 0,
					UNITS.RECON: 65, UNITS.LIGHT_TANK: 55, UNITS.MEDIUM_TANK: 25,
					UNITS.ARTILLERY: 65, UNITS.HEAVY_ARTILLERY: 65, UNITS.ANTI_AIR: 25,
					UNITS.DRONE: 0, UNITS.BATTLESHIP: 25},
				w2_dmg_chart = {UNITS.LIGHT_INFANTRY: 75, UNITS.HEAVY_INFANTRY: 75,
					UNITS.RECON: 30, UNITS.LIGHT_TANK: 6, UNITS.MEDIUM_TANK: 1,
					UNITS.ARTILLERY: 25, UNITS.HEAVY_ARTILLERY: 35, UNITS.ANTI_AIR: 6,
					UNITS.DRONE: 65, UNITS.BATTLESHIP: 0},
				atk_type = ATTACK_TYPE.DIRECT,
				cost = 9000,
				can_capture = false},
			UNITS.BATTLESHIP:
