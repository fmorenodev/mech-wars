...
var co_data: Dictionary = {
				...
				COS.BANDIT: {
					...
					UNITS.HEAVY_INFANTRY: Vector3(1.1, 1.1, 0), UNITS.RECON: Vector3(1, 0.9, 0),
					...
					UNITS.ANTI_AIR: Vector3(1, 0.9, 0), UNITS.DRONE: Vector3(1, 0.9, 0),
				...
				COS.EVIL_MARK0: {
					...
					UNITS.HEAVY_INFANTRY: Vector3(1.3, 1, 0), UNITS.RECON: Vector3(1.3, 1, 0),
					...
					UNITS.ANTI_AIR: Vector3(1.3, 1, 0), UNITS.DRONE: Vector3(1.3, 1, 0),
