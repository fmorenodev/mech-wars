...
# TODO: add info on what weapons will hit what units
...
var buildings = {BUILDINGS.RUINS: {name = tr('RUINS'), desc = tr('RUINS_DESC')},
				BUILDINGS.RUINS_2: {name = tr('RUINS'), desc = tr('RUINS_DESC')},
				BUILDINGS.FACTORY: {name = tr('FACTORY'), desc = tr('FACTORY_DESC')},
				BUILDINGS.AIRPORT: {name = tr('AIRPORT'), desc = tr('AIRPORT_DESC')},
				BUILDINGS.PORT: {name = tr('PORT'), desc = tr('PORT_DESC')},
				BUILDINGS.RESEARCH: {name = tr('RESEARCH'), desc = tr('RESEARCH_DESC')},
				BUILDINGS.POWER_PLANT: {name = tr('POWER_PLANT'), desc = tr('POWER_PLANT_DESC')},
				}
